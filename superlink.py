...
class SuperLink():
    ...
    def superlink_flow_coefficients(self, u=None):
        """
        ...
        # If no input signal, assume pipe is closed
        if u is None:
            u = np.zeros(self.n_l, dtype=np.float64)
        if _end_method == 'o':
            _X_1k = _X_Ik[_I_1k]
            _Y_1k = _Y_Ik[_I_1k]
            _Z_1k = _Z_Ik[_I_1k]
    ...
    def solve_superlink_flows(self, u=None):
        """
        ...
        # If no input signal, assume pump is closed
        if u is None:
            u = np.zeros(self.NK, dtype=np.float64)
...
# what's this!!        # TODO: Move this inside numba function
    ...
    def solve_internals_forwards(self, supercritical_only=False, u=None):
        """
    ...
    def solve_internals_backwards(self, u=None):
        """
    ...
    def _setup_step(self, H_bc=None, Q_in=None, Q_0Ik=None, u_l=None, u_o=None, u_w=None, u_p=None, u_prv = None, dt=None,
        ...
        # if self.superlinks is not None:
        #     self.superlink_flow_coefficients(u=u_l)     
        if self.orifices is not None:
    ...
    def _solve_step(self, H_bc=None, Q_in=None, Q_0Ik=None, u_l=None, u_o=None, u_w=None, u_p=None, u_prv = None, dt=None,
             first_time=False, implicit=True, banded=False, first_iter=True):
        ...
        if self.superlinks is not None:
            self.solve_superlink_flows(u=u_l)
        if self.orifices is not None:
        ...
        if _method == 'b':
            ...
            self.solve_internals_forwards(u=u_l)
        elif _method == 'nnls':
    ...
    def step(self, H_bc=None, Q_in=None, Q_0Ik=None,u_l=None, u_o=None, u_w=None, u_p=None, u_prv = None, dt=None,
        ...
        u_l : np.ndarray (l)
            Pipe control signal. Represents fraction of maximum pipe open (0-1).
        dt : float
        ...
        if banded is None:
            banded = self.banded
        self._setup_step(H_bc=H_bc, Q_in=Q_in, Q_0Ik=Q_0Ik, u_l=u_l, u_o=u_o, u_w=u_w, u_p=u_p, u_prv=u_prv, dt=dt,
                         first_time=first_time, implicit=implicit, banded=banded,
                         first_iter=first_iter)
        self._solve_step(H_bc=H_bc, Q_in=Q_in, Q_0Ik=Q_0Ik, u_l=u_l, u_o=u_o, u_w=u_w, u_p=u_p, u_prv=u_prv, dt=dt,
                         first_time=first_time, implicit=implicit, banded=banded,
                         first_iter=first_iter)
